...
def predict_emails():
    ...
    for email_body in emails:
        ...
        if data['prediction'] == "cfp" and data['submission_deadline'] is not None and data['start_date'] is not None and data['location'] is not None and len(data['date_to_sentence']) >= 3:
